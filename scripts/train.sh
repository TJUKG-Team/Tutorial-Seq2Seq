...
python Seq2Seq_train.py --model_name LSTM --dataset Multi30k --trian_from_zero
# python Seq2Seq_train.py --model_name GRU --dataset Multi30k
# python Seq2Seq_train.py --model_name GRU_Attention --dataset Multi30k

# python Seq2Seq_train.py --model_name LSTM --dataset DailyDialog --batch_size 16 --trian_from_zero
