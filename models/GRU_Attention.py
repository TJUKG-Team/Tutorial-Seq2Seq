...
class GRU_Attention(nn.Module):
    def __init__(self, args):
        ...
        self.encoder = Encoder(args.input_dim, args.enc_emb_dim, args.enc_hid_dim, args.dec_hid_dim, args.enc_dropout)
        self.attention = Attention(args.enc_hid_dim, args.dec_hid_dim)
        self.decoder = Decoder(args.output_dim, args.dec_emb_dim, args.enc_hid_dim, args.dec_hid_dim, args.dec_dropout, self.attention)
...
class GRU_Attention_inference(GRU_Attention):
    def __init__(self, args):
        super().__init__(args)
